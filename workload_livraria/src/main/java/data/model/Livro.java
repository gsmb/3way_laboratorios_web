...
public class Livro {
	...
	public Livro(long id, String codLivro, String titulo, String autor,
			String imagem, String descricao, double preco) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Livro [id=" + id + ", codLivro=" + codLivro + ", titulo="
				+ titulo + ", autor=" + autor + ", imagem=" + imagem
